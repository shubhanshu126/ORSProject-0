...
public class JasperCtl {
	...
	public void display(HttpServletRequest request, HttpServletResponse response) throws JRException, SQLException, IOException {
		...
		String path = context.getRealPath("G:\\ank-p-0\\ORSProject_0-main\\ORSProject_0-main\\src\\main\\webapp\\WEB-INF\\Marksheet.jrxml");
		System.out.println("in jasper");
		Connection con = null;
		JasperReport jasperReport = JasperCompileManager.compileReport("G:\\ank-p-0\\ORSProject_0-main\\ORSProject_0-main\\src\\main\\webapp\\WEB-INF\\Marksheet.jrxml");
